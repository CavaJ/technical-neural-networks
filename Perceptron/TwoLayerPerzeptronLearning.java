...
public class TwoLayerPerzeptronLearning
{
	public static void main(String[] args)
	{
		...
		try {
			...
			*/
			...
			// ------------THIS CAN ALSO BE DONE BY READING FROM FILE --------
			...
			System.err.println("Error while reading a file \"PA-A-train.dat\": " + e.getMessage());
		}
		finally {
			try {
